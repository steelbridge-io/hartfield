...
<div id="footer">
    <div class="footer-newsletter">
        <div class="newsletter-content">
            ...
            <div id="mc_embed_signup">
                <form action="https://YOUR-MAILCHIMP-URL.list-manage.com/subscribe/post?u=YOUR_USER_ID&amp;id=YOUR_LIST_ID" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
    ...
    <div class="footer-creds">
        <?php
        // Allow managing footer credits via HF Manager option, fallback to existing markup
        $default_footer_creds = '<p>Copyright © Hartfield Financial &amp; Insurance Services, Inc.   |   <a href="https://wp.hartfieldfinancial.xyz/privacy-policy/">Privacy Policy</a>   |   <a href="https://s57396.gridserver.com/.tools/webmail/">Webmail</a></p>'
        ...
        $footer_creds = get_option('hf_footer_creds', $default_footer_creds);
