<?php
/**
 * hartfield-financial functions and definitions
 *
 ...
 */
function hartfield_financial_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on hartfield-financial, use a find and replace
		* to change 'hartfield-financial' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'hartfield-financial', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'hartfield-financial' ),
      'primary' => __('Primary Menu', 'hartfield-financial'),
      'subnav'  => __('Sub Navigation', 'hartfield-financial')
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'hartfield_financial_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'hartfield_financial_setup' );
 ...
 */
function hartfield_financial_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'hartfield_financial_content_width', 640 );
}
add_action( 'after_setup_theme', 'hartfield_financial_content_width', 0 );
 ...
 */
function hartfield_financial_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'hartfield-financial' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'hartfield-financial' ),
...
add_action( 'widgets_init', 'hartfield_financial_widgets_init' );
...
function hartfield_financial_scripts() {
  ...
  wp_enqueue_style('spry-tabs-css', get_stylesheet_directory_uri() . '/SpryAssets/SpryTabbedPanels.css', array(), _S_VERSION);
...
add_action( 'wp_enqueue_scripts', 'hartfield_financial_scripts' );
